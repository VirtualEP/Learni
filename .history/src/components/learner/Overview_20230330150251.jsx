      ...
      <div className="w-3/4 border-r bg-white-50 flex flex-col  space-y-8 border-gray-100 px-5">
            ...
            <div className="stat-figure text-secondary">
              <div className="avatar online">
                <div className="w-16 rounded-full">
                  <img src={"https://images.unsplash.com/photo-1543278732-824a807df8bd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=654&q=80"} />
                </div>
              </div>
            </div>
        ...
        <div className="mt-5">
          ...
          <div className="overflow-x-auto mt-5">
            <table className=" table-zebra w-full text-white">
              {/* head */}
              <thead className="">
                <tr>
                  <th>Course Title</th>
