                  ...
                  <form method="POST">
                    <div className="grid md:grid-cols-2 gap-4 w-full py-2">
                      <div className="flex flex-col">
                        ...
                        <input
                          className="border-2 rounded-lg bg-white  p-3 flex border-purple-100"
                          name="name"
                          required
                          type="text"
                        />
                    ...
                    <div className="flex flex-col py-2">
                      ...
                      <textarea
                        className="border-2 rounded-lg bg-white  p-3 border-purple-100"
                        rows="10"
                        required
                      ></textarea>
                    </div>
                    <button className="border-2 border-purple-600 px-4 py-3 my-2 mx-auto flex items-center">
                      Send Message
                    </button>
                  </form>
                </div>
