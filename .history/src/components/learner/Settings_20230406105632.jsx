                            ...
                            <form method='POST'>
                                <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
                                    <div className="flex flex-col">
                                        ...
                                        <input className='border-2 rounded-lg bg-white  p-3 flex border-purple-100' name="name" required type="text" />

                                    </div>
                                    <div className="flex flex-col">
                                        <label className='text-sm uppercase py-2'>Phone number</label>
                                        <input className='border-2 rounded-lg bg-white  p-3 flex border-purple-100' name="number" required type="text" />
                                    </div>
                                </div>
                                <div className="flex flex-col py-2">
                                    <label className='text-sm uppercase py-2'>Email</label>
                                    <input className='border-2 rounded-lg bg-white  p-3 flex border-purple-100' name="email" required type="email" />
                                </div>
                                <div className="flex flex-col py-2">
                                    <label className='text-sm uppercase py-2'>Subject</label>
                                    <input className='border-2 rounded-lg bg-white   p-3 flex border-purple-100' required type="text" />
                                </div>
                                <div className="flex flex-col py-2">
                                    <label className='text-sm uppercase py-2'>Message</label>
                                    <textarea className="border-2 rounded-lg bg-white  p-3 border-purple-100" rows='10' required></textarea>
                                </div>
