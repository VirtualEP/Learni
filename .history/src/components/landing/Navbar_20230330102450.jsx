    ...
    return (
        <div className={shadow ? 'w-full h-[80px] z-10 bg-white fixed drop-shadow-lg' : 'w-full h-[80px] z-10 bg-white fixed'}
            ...
            <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16'>
                ...
                <h1 className="text-2xl font-bold cursor-pointer capitalize">Lear<span className="text-blue-600 lowercase">ni</span></h1>
                    {/* MENU ITEMS */}
                    <div className='hidden md:flex'>
                        <ul style={{ color: `${Color}` }} className='hidden md:flex'>
                            <a href="/#home">
                                <li className='ml-10 text-md  border-b-4 hover:border-blue-600'>Home</li>
                            </a>
                            <a href="/#courses">
                                <li className='ml-10 text-md  hover:border-b-4 hover:border-blue-600'>Courses</li>
                            </a>
                            <a href="/#mentors">
                                <li className='ml-10 text-md  hover:border-b-4 hover:border-blue-600'>Mentors</li>
                            </a>
                        </ul>
                    </div>
                </div>
            ...
            <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70' : ''}>
                <div className={nav ? 'md:hidden fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500' : 'fixed left-[-100%] top-0 p-10 ease-in duration-500'}>
                    <div>
                        ...
                        <h1 className="text-2xl cursor-pointer font-bold capitalize">Lear<span className="text-blue-600 lowercase">ni</span></h1>
