  ...
  return (
    <div>
     <section id="home" class="w-full bg-[#EDEEF8] lg:h-screen h-full py-24">
                      ...
                      <div class="grid lg:grid-cols-2 items-center">
                          <div class="md:mt-12 lg:mt-0 mb-12 lg:mb-0">
                              <div class="block rounded-lg shadow-lg px-6 py-12 md:px-12 lg:-mr-14" style={{background:" hsla(0, 0%, 100%, 0.55)", backdropFilter:" blur(30px)"}}>
                                  <h1 class="text-4xl md:text-5xl xl:text-6xl font-bold tracking-tight mb-12">Quality Education <br /><span class="text-blue-600">accessible online</span></h1>
            ...
            <Link href="/#about">
              <div className="rounded-full animate-bounce shadow-md shadow-purple-600 p-4 cursor-pointer hover:scale-110 ease-in duration-300">
                <HiOutlineChevronDoubleDown
                  size={30}
                  className="m-auto text-[#9333EA]"
                />
              </div>
            </Link>
          </div>                    
