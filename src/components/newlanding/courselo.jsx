        ...
        <div className="flex w-screen flex-col">
            <div className="flex-1 flex pb-10 md:pb-0 md:min-h-[100vh] bg-black min-h-[70vh] ">
                <div className="container mx-auto flex-1 flex flex-col">
                    ...
                    <div className="flex flex-col space-y-5 md:space-y-0 md:flex-row  md:items-center m-5 md:my-10 md:justify-between font-light mb-10">
                        ...
                        <div ref={ navbar_actions} className="flex  md:flex items-center text-white space-x-5">
                            <Link className='bg-gray-900 px-10 py-2 rounded md:p-0 md:rounded-none md:bg-transparent' to="/signin">Login</Link>
                            <Link className='bg-white text-black font-bold px-8 py-2 rounded' to="/signup">Sign up</Link>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col md:flex-row items-center justify-center flex-1  space-x-10'>
                        <div className=' flex flex-col space-y-5 px-3 md:px-0'>
                            <p className="font-bold uppercase text-white text-xs">upgrade your skill</p>
                            <h3 className="text-5xl md:text-7xl text-white font-bold">Explore live <br /> creative classes</h3>
                            <p className="text-gray-300 font-light text-md">Joing growing community and get peer insights and discover exciting opportunities and collaborations.</p>
                            <div className='flex items-center space-x-5'>
                                <Link className='text-white bg-blue-600 font-semibold px-8 py-2 rounded' to="#">Sign up</Link>
                        ...
                        <div className='hidden md:flex flex-1  h-full space-x-3 items-center justify-center'>
                            ...
                            <div className='w-[18vw] flex flex-col space-y-2  h-full'>
                                ...
                                <div className='bg-white h-3/4 w-full p-3 rounded'></div>
            ...
            <div className='bg-gray-50 p-5 py-20 min-h-[20vh]'>
                <div className='container mx-auto flex flex-col md:flex-row items-center md:space-x-5 md:space-y-0 space-y-5'>
                    <div className='w-full md:w-1/3 md:border-r  border-black '>
                        <h3 className='hidden md:block text-4xl font-bold capitalize text-gray-800 leading-snug'>Online <br /> Learning <br /><span className='text-blue-600'>designed</span> for <br /> Students.</h3>
                        <h3 className='md:hidden text-4xl font-bold capitalize text-gray-800 leading-snug'>Online Learning <br /><span className='text-blue-600'>designed</span> for <br /> Students.</h3>
                    </div>
                    <div className='flex items-center'>
                        <div className='flex-1 md:px-5 flex flex-col space-y-2'>
                            ...
                            <p className='font-light text-sm text-gray-500'>packed with morden technology and classroom learning experince.</p>
                        </div>
                        <div className='flex-1 md:px-5 flex flex-col space-y-2'>
                            <img src='http://placehold.it/' />
                            <h4 className='font-bold'>Packed with morden technology</h4>
                            <p className='font-light text-sm text-gray-500'>packed with morden technology and classroom learning experince.</p>
                        </div>
            ...
            <div className='min-h-[60vh] flex p-5'>
                <div className='container mx-auto flex-1 flex flex-col md:flex-row items-center justify-center'>
                    ...
                    <div className='flex-1 flex flex-col space-y-5 h-full justify-center'>
                        <h3 className='font-bold text-4xl leading-snug'>Expirenced <br /> Course Mentor</h3>
                        <p className='text-gray-500 font-light'>Utilize this media to present various kind od learning materials, campus acadamic system and various other educational needs.</p>
                        <div className='pt-5'>
                            <Link className='text-white bg-blue-600 font-semibold px-8 py-3 rounded' to="/dashboard/explore">Start Learning</Link>
                        </div>
            ...
            <div className='relative h-full overflow-hidden'>
                <div className='min-h-[80vh] flex md:flex-row flex-col w-full'>
                    <div className='md:w-3/5  bg-gray-100 md:rounded-r-2xl'>
                    </div>
                    ...
                    <div className='flex flex-col-reverse md:flex-row items-center flex-1 container mx-auto'>
                        ...
                        <div className='flex-1 rounded-r-2xl px-5 md:px-0'>
                            <div className='container mx-auto md:pr-10 flex flex-col space-y-6'>
                                <h3 className='font-bold text-3xl md:text-4xl leading-snug'>Keep your students <br /> engaged<span className='text-blue-400'>.</span></h3>
                                <p className='text-gray-700 font-light md:text-justify'>We help you create an interactive and captivating learning environment for your students. We understand that student engagement is crucial for effective learning, and we're here to provide you with practical strategies and innovative ideas to make your courses come alive.</p>
                                <p className='text-gray-700 font-light md:text-justify'>We help you create an interactive and captivating learning environment for your students. We understand that student engagement is crucial for effective learning, and we're here to provide you with practical strategies and innovative ideas to make your courses come alive.</p>
                                <Link className='flex items-center space-x-3 text-black font-bold  py-2 rounded' to="#">
                                    <p>Read more</p>
                        ...
                        <div className='md:w-3/5 flex flex-1 items-center h-full space-x-5 py-10 justify-center px-5 md:px-0'>
                            <div className='flex flex-col flex-1 h-full space-y-5 justify-center'>
                                <div className='min-h-[45%] bg-white space-y-3 shadow-sm justify-center flex flex-col p-7 text-gray-500 font-light text-md border rounded border-t-4 border-t-violet-600'>
                                    <img src="http://placehold.it/" />
                                    <h4 className='font-bold text-black'>Engage your audience.</h4>
                                    <p className='hidden md:block'>our learning management system creates a personalize experince for the learners.</p>
                                </div>
                                <div className='min-h-[45%] bg-white space-y-3 shadow-sm justify-center flex flex-col p-7 text-gray-500 font-light text-md border rounded border-t-4 border-t-blue-600'>
                                    <img src="http://placehold.it/" />
                                    <h4 className='font-bold text-black'>Turn ideas into reality.</h4>
                                    <p className='hidden md:block'>our learning management system creates a personalize experince for the learners.</p>
                                </div>
                            ...
                            <div className='flex flex-col flex-1 h-full space-y-5 justify-center'>
                                ...
                                <div className='min-h-[45%] bg-white space-y-3 shadow-sm justify-center flex flex-col p-7 text-gray-500 font-light text-md border rounded border-t-4 border-t-violet-600'>
                                    <img src="http://placehold.it/" />
                                    <h4 className='font-bold text-black'>Put the fun into learning.</h4>
                                    <p className='hidden md:block'>our learning management system creates a personalize experince for the learners.</p>
                                </div>
            ...
            <div className='min-h-[100vh] overflow-hidden flex  flex-col md:flex-row items-center justify-center'>
                <div className='bg-black min-h-[70vh]  mx-auto md:w-[90vw] md:rounded-xl p-10 flex flex-col space-y-10 md:items-center justify-center'>
                    <h3 className='text-white  text-4xl text-left md:text-center'>Top Courses<span className='text-blue-300'>.</span></h3>
                    <p></p>
                    <div className='flex items-center space-x-5  overflow-x-auto w-full'>
                        <div className='w-[250px] flex flex-col space-y-3'>
                            <div className='w-[250px] bg-gray-200  h-40 rounded-lg overflow-hidden bg-center bg-cover' style={{ backgroundImage: `url('https://images.unsplash.com/photo-1687229763648-c3f43c8ffb22?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=776&q=80')` }}>

                            </div>
                            <h3 className='text-white font-bold text-sm'>Programing: Introduction to Python programming</h3>
                            <div className='flex flex-row items-center space-x-2'>
                                <div className='h-8 w-8 rounded-full bg-white relative'>
                                </div>
                                <h2 className='text-white'>Devtray</h2>
                                <div className='flex-1'></div>
                                <Link to="#" className='text-indigo-400 shrink-0 font-semibold border-b border-b-indigo-400'>Join Class</Link>
                            </div>
                        </div>
                    ...
                    <Link className='text-white bg-blue-600 font-semibold px-8 py-3 rounded w-fit' to="/dashboard/explore">Start Learning</Link>
