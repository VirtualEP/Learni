...
export default function instructorLessons(props) {
    ...
    return (
        <div className='flex-1 flex flex-col   h-full relative overflow-hidden'>
            <div className='flex-1 space-y-2 flex flex-col overflow-y-auto'>
            ...
            {showAddMedia && <div className='bg-white absolute -top-0 right-0 w-full h-[100%] flex'>
                <UploadMedia onSuccess={onSuccess} onFailure={onFailure} onClose={e => setShowAddMedia(false)} topics={topics} />
            </div>}
        </div>
    )
}
