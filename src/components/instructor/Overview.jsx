    ...
    <div className="flex-1 flex flex-row  space-x-3 overflow-hidden">
          ...
          <div>
            <div className="flex flex-row space-x-3">
              ...
              <div className="flex flex-col mt-1 space-y-1">
                ...
                <p className="text-gray-500 font-light text-sm">My installation proccess didn't work on my windows machine.</p>
      ...
      <div className=' w-1/3 h-[100%] flex flex-col space-y-5'>
        ...
        <div className="border flex flex-col space-y-3 p-5 text-sm">
          <div className="flex flex-col space-y-1">
            ...
            <h3 className="font-medium text-sm text-gray-600">Video received a copyright claim</h3>
          </div>
          <p className='text-gray-500 font-light'>A copyright owner claimed some content in your video, "Internet reaction to The Little Mermaid #trevornoah #hailey #hiphop #music #movie #rap #hiphop". Please note: This is not a copyright strike.
            May 29, 2023, 6:24 PM</p>
        </div>
        <div className='w-full min-h-80 flex flex-col  '>
          ...
          <div className="w-full flex-1 flex flex-col h-full border">
            ...
            <div className=" p-5">
              <h3 className='pb-1 font-medium text-gray-700'>Recent Enrollments</h3>
              <p className="text-xs text-gray-400">Most recent enrollment to in your courses.</p>
              <div className="h-5"></div>
              {/* recent card */}
              {
                [1, 2, 3, 4, 5].map((data, index) => <div className="my-2" key={`recent-enrolment-${index}-`}>
                  <div className="flex flex-row space-x-3">
                  ...
                  <div className={`${index !== 4 && 'border-b py-4'} border-gray-50  pl-5`}>
        ...
        {/* analytics */}
        <div className='w-1/3   h-[100%] flex flex-col'>
      ...
      <div className=' w-1/3 h-[100%] flex flex-col space-y-5'>
        ...
        <div className="border flex flex-col space-y-3 p-5 text-sm">
          ...
          <h3 className="font-bold text-sm text-gray-600">How to create a new course</h3>
          <p className='text-gray-500 font-light'>Learn to create and publish a new course to iLearn</p>
        </div>
          ...
          <div className="flex flex-col space-y-2">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <p>1 <span className="text-gray-300">/</span> 3</p>
                <button>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
            ...
            <div className="h-36  bg-center bg-cover" style={{ backgroundImage: `url(https://www.freecodecamp.org/news/content/images/2022/02/Banner-10.png)` }}>
