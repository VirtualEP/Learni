...
export default function CourseSummary() {
    return (
        <div className="my-10 flex-1 flex flex-col w-3/4">
            ...
            <p className="my-4 text-xs text-gray-500 leading-5">In this course, you will learn basics of computer programming and computer science. The concepts you learn apply to any and all programming languages and will be a good base onto which you can build your skills.This video is meant for those who are interested in computer science and programming but have no idea where to start and have little to no background information on coding.</p>
            <div className="flex items-center space-x-5 pb-5 border-gray-100 mt-2 font-light w-2/3">
                ...
                <div className='text-xs '>
                    <h3>Enroll to gain access to all <span className='font-bold text-gray-700'>11 recoreded Lesson</span> and <span className='font-bold text-gray-700'>Instructor's Contact</span> for further questions.</h3>
                </div>
            </div>
