...
export default function ExploreInfo({ data }) {
  ...
  const paymentConfig = {
    ...
    publicKey: "pk_live_f4b2dd9594ad0249e23a2a38e07d1a16036157be",
  };
    ...
    <>
      <div className="flex-1 flex flex-col overflow-hidden overflow-y-auto">
        <div className="h-52 bg-gray-100 my-5 mx-5 rounded-xl overflow-hidden shrink-0">
          <img className="w-full" src={API_ROUTES + '/' + data.cover} onError={e => e.target.src = 'https://reactnativecode.com/wp-content/uploads/2018/02/Default_Image_Thumbnail.png'} />
        </div>
        <div className="mx-10 flex-1 flex flex-col">
          ...
          <div className="flex md:flex-row space-y-5 md:space-y-0 flex-col items-center space-x-5 border-b pb-5 border-gray-100 mt-2 font-light">
            {!data.live ? (
          ...
          <div className="flex-1 flex flex-col space-y-5 py-3">
            ...
            <div className="flex-1 ml-3 space-y-5">
              ...
              <div className="items-center py-5 flex md:hidden">
              <button
              ...
              <button
                onClick={initializePaymentAction}
                className=" flex bg-gray-200 py-4 px-5 text-center justify-center md:hidden cursor-pointer"
                htmlFor="my-modal-4"
              >
