    ...
    return (
        <div onClick={onClick} className="flex items-center space-x-5 hover:bg-blue-50 bg-blur-md hover:rounded-xl hover:p-3 cursor-pointer transition-all hover:border border-gray-100">
            ...
            <div className="space-y-3 flex flex-col">
                ...
                <div className="flex-1 space-x-5 h-full w-full  flex items-center">
                    <div className="flex items-center space-x-1">
                        ...
                        <p className='text-sm'>{data.testimonials.length}</p>
                    </div>
                    <div className="flex items-center space-x-1">
                        ...
                        <p className='text-sm'>{data.students.length}</p>
                    </div>
                    <div className="flex items-center space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-3 h-3">
                        ...
                        <p className='text-sm'>{data.stars}</p>
                    </div>
                </div>
            </div>
            <div className="flex-1"></div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-gray-100 hover:text-blue-500">
