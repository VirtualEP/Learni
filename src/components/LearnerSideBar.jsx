    ...
    <div className="md:w-1/5 border-r flex flex-col">
      <div className="w-full flex flex-col space-y-6 p-3">
        ...
        <div className="flex items-center justify-between">
          <Link to="/dashboard/courses" className="flex items-center md:justify-center p-4 ">
            <svg
          ...
          <button onClick={e => setSmMenuShow(prev => !prev)} className="mr-5 md:hidden flex">
            {!smMenuShow ? <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        <div className=" flex-col space-y-5 hidden md:flex">
          <SideNavLink Icon={() => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <AnimatePresence>
          {smMenuShow && < motion.div initial={{ translateY: -10, height: '0px', opacity: 0 }} exit={{ translateY: -10, height: '0px', opacity: 0 }} animate={{ height: '100%', translateY: 0, opacity: 1 }} className="flex flex-col space-y-5 md:hidden overflow-hidden pb-5 z-10 md:z-0 bg-white -mx-3 px-3 md:px-0 md:mx-0">
            <SideNavLink Icon={() => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941" />
            </svg>
            }
...
function SideNavLink({ title, Icon, to, lock }) {
  ...
  if (lock !== user.user.accountType && lock !== undefined) {
    return <></>;
  }
