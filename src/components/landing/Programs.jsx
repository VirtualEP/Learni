      ...
      <div className="container mx-auto flex flex-col md:flex-row md:space-x-5 space-y-4 md:space-y-0 my-10 p-2">
        <div className="md:w-1/3 min-h-48 flex flex-col space-y-5 bg-white border p-2 rounded-md overflow-hidden">
          <div
            ...
            style={{
              backgroundImage: `url('https://images.unsplash.com/photo-1649180556628-9ba704115795?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1462&q=80')`,
            }}
          ></div>
        ...
        <div className="md:w-1/3 min-h-48 flex flex-col space-y-5 bg-white border p-2 rounded-md overflow-hidden">
          <div
            className="h-40 bg-cover bg-center rounded-md overflow-hidden"
            style={{
              backgroundImage: `url('https://images.unsplash.com/photo-1526379095098-d400fd0bf935?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1632&q=80')`,
            }}
          ></div>
          <div className="p-2 flex flex-col space-y-2">
            <p className="text-gray-400 capitalize text-xs">python</p>
        ...
        <div className="md:w-1/3 min-h-48 flex flex-col space-y-5 bg-white border p-2 rounded-md overflow-hidden">
          <div
            className="h-40 bg-cover bg-center rounded-md overflow-hidden"
            style={{
              backgroundImage: `url('https://images.unsplash.com/photo-1515879218367-8466d910aaa4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1469&q=80')`,
            }}
          ></div>
          <div className="p-2 flex flex-col space-y-2">
            <p className="text-gray-400 capitalize text-xs">python</p>
