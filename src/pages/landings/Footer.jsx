        ...
        <div className='bg-gray-50 min-h-[40vh] flex  border-t px-5'>
            <div className='flex-1 flex flex-col md:flex-row container mx-auto py-10 md:space-x-10 space-y-5 md:space-y-0'>
                ...
                <div className='md:w-1/3 flex flex-col space-y-5 md:border-r'>
                    ...
                    <p className='text-sm font-light text-gray-500'>We help you create an interactive and captivating learning environment for your students. We understand that student engagemen</p>
                ...
                <div className='flex-1 flex flex-col md:flex-row space-y-5 '>
                    <div className="md:w-1/3 flex flex-col space-y-3">
                        ...
                        <p>
                            A. Arhinful  Ave PT78,<br />Anaji - Takoradi<br />Ghana
                        </p>
                        <Link to="mailto:support@devtray.net" >support@devtray.net</Link>
                        <div>
                            <Link to="tel:support@devtray.net" >020 087 2923</Link>,
                            <Link to="tel:support@devtray.net" > 029 087 2923</Link>
                        </div>
                    </div>
                    <div className="md:w-1/3 flex flex-col space-y-3">
